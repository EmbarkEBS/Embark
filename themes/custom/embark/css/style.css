        ...
        if($('#our-work').length)
        {
          $(window).scroll(function (event) {
            ...
            $('.work-scrolling').toggleClass('first',
              scroll >= $('.work-right .one').offset().top - 700
            );
            $('.work-scrolling').toggleClass('second',
              scroll >= $('.work-right .two').offset().top - 700
            );
            $('.work-scrolling').toggleClass('third',
              scroll >= $('.work-right .three').offset().top - 700
            );
$('.work-scrolling').toggleClass('fourth',
              scroll >= $('.work-right .four').offset().top - 700
            );
			$('.work-scrolling').toggleClass('fifth',
              scroll >= $('.work-right .five').offset().top - 700
            );
...
//service offered
jQuery(document).ready(function() {
	jQuery('#tech-service .tabs .tab-links a').on('click', function(e) {
		var currentAttrValue = jQuery(this).attr('href');

		// Show/Hide Tabs
		jQuery('#tech-service .tabs ' + currentAttrValue).show().siblings().hide();
...
jQuery(document).ready(function() {
	jQuery('#tech-service-1 .tabs .tab-links a').on('click', function(e) {
		var currentAttrValue = jQuery(this).attr('href');

		// Show/Hide Tabs
		jQuery('#tech-service-1 .tabs ' + currentAttrValue).show().siblings().hide();
...
function makeTimer() {
  ...
  function makeTimer1() {
    ...
    //		var endTime = new Date("29 August 2023 9:56:00 GMT+01:00");
      var endTime = new Date("29 August 2023 9:56:00 GMT+01:00");
        endTime = (Date.parse(endTime) / 1000);
